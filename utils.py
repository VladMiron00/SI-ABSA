...
def compare_preds(pred1,pred2):
    # if the prediction of the interpretable and original black box match, 1; else 0;
...
def get_polarity(in_file):
    ...
    with open(in_file, 'r') as labelled_dataset:
        # sen=0
        for index, line in enumerate(labelled_dataset):
            if index == cnt: #and sen<10:
                cnt+=3
                # sen+=1
                ...
                if int(sentiment) == -1:
                    ...
                    cnt_pos += 1
    print("input file "+in_file+" has sentiments: "+"neg: "+str(cnt_neg)+", neu: "+str(cnt_neu)+", pos: "+str(cnt_pos))
    # input file 768traindata2016.txt has sentiments: neg: 489, neu: 72, pos: 1319
    # input file 768testdata2016.txt has sentiments: neg: 135, neu: 32, pos: 483
    # input file 768remainingtestdata2016.txt has sentiments: neg: 82, neu: 22, pos: 144


if __name__ == '__main__':
    in_file='C://Users//Family//Explaining_ABSA_v2//data//programGeneratedData//'
    # 768remainingtestdata2016.txt
    # 768testdata2016.txt
    # 768traindata2016.txt
    get_polarity(in_file+'768remainingtestdata2016.txt')
'''
